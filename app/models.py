...
class Telephone(db.Model):
    ...
    n_gef = db.Column(db.Integer, db.ForeignKey('gef.id'))
...
class GefEquipement(db.Model):
    ...
    n_gef = db.Column(db.Integer, db.ForeignKey('gef.id'), primary_key=True)
...
class GefAgrement(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True)
    gef_n = db.Column(db.Integer, db.ForeignKey('gef.id'))
